...
<main class="content" id="content">
    <div class="main_content">
        ...
        <div class="project-content">
            ...
            <a href="/projects/issues" class="btn btn-back"><i class="fa-solid fa-arrow-left"></i> 목록으로 돌아가기</a>
        </div>
        ...
        <form class="project-form" action="#" method="post" enctype="multipart/form-data">
            ...
            <div class="form-row group-row">
                <div class="form-group main-text">
                    <label>이슈 ID <span class="required-icon">*</span></label>
            ...
            <div class="form-row group-row">
                <div class="form-group description-area">
                    <label>이슈내용 <span class="required-icon">*</span></label>
            ...
            <div class="form-row group-row gap-row">
                <div class="form-group">
                    <label>이슈 상태 <span class="required-icon">*</span></label>
            ...
            <div class="btn-actions">
                ...
                <% } %>
                <% if (type == null) { %>
                    <button type="button" class="modify-btn" onclick="window.location.href='/projects/issueInfo?type=modify'">
